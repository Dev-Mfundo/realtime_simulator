const {getSymbolData} = require('../../src/controllers/market_stream_controller')
...
describe("getSymbolData", () => {
  it("should return 400 if symbol or timeframe is missing", async () => {
    ...
    expect(res.status().json).toHaveBeenCalledWith({ error: "Both symbol and timeframe input are required" });
  });
});
